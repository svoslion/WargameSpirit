 ...
 */
final class Version20221109115446 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subject_category (subject_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_3E3159A923EDC87 (subject_id), INDEX IDX_3E3159A912469DE2 (category_id), PRIMARY KEY(subject_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
